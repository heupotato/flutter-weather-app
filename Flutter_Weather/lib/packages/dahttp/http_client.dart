...
import 'package:flutter_weather/packages/dahttp/http_logger.dart';
import 'package:flutter_weather/packages/dahttp/http_result.dart';
...
abstract class ValuedHttpClient<T> {
  ...
  _CustomClient _client() => _CustomClient(this.logger);
